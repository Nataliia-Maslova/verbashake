...
from engine.recommender import LANG_TO_CODE
...
_LEVEL_NAMES: dict[str, list[str]] = {
    ...
    "fr": ["Débutant", "Apprenant", "Étudiant", "Praticien", "Spécialiste", "Maître", "Expert"],
    "de": ["Anfänger", "Lernender", "Student", "Übender", "Spezialist", "Meister", "Experte"],
    "ja": ["初心者", "学習者", "生徒", "実践者", "専門家", "達人", "エキスパート"],
    "zh": ["初学者", "学习者", "学生", "练习者", "专家", "大师", "高手"],
    "pt": ["Iniciante", "Aprendiz", "Estudante", "Praticante", "Especialista", "Mestre", "Perito"],
    "it": ["Principiante", "Apprendista", "Studente", "Praticante", "Specialista", "Maestro", "Esperto"],
    "pl": ["Początkujący", "Uczeń", "Student", "Praktyk", "Specjalista", "Mistrz", "Ekspert"],
    "ru": ["Начинающий", "Ученик", "Студент", "Практик", "Специалист", "Мастер", "Эксперт"],
    "ca": ["Principiant", "Aprenent", "Estudiant", "Practicant", "Especialista", "Mestre", "Expert"],
    "nl": ["Beginner", "Leerling", "Student", "Beoefenaar", "Specialist", "Meester", "Expert"],
}

# map Streamlit launcher_native (a full language name, e.g. "French") → the
# 2-letter code the tables above are keyed by — reuses the one canonical
# 14-language map instead of duplicating a partial copy of it here (this
# used to be a local 4-entry dict, silently falling back to English for the
# other 10 supported languages).
_NATIVE_TO_CODE = LANG_TO_CODE
...
_UI: dict[str, dict[str, str]] = {
    ...
    "fr": {
        ...
        "days":        "jours",
        "no_streak":   "0 jour",
        "xp_next":     "+{n} XP avant le niveau suivant",
        "xp_max":      "Niveau maximum !",
        "time_label":  "Temps d'étude",
        "time_h":      "h",
        "time_m":      "min",
        "time_zero":   "< 1 min",
    },
    "de": {
        ...
        "days":        "Tage",
        "no_streak":   "0 Tage",
        "xp_next":     "+{n} XP bis zum nächsten Level",
        "xp_max":      "Maximales Level!",
        "time_label":  "Lernzeit",
        "time_h":      "Std",
        "time_m":      "Min",
        "time_zero":   "< 1 Min",
    ...
    "pt": {
        ...
        "days":        "dias",
        "no_streak":   "0 dias",
        "xp_next":     "+{n} XP para o próximo nível",
        "xp_max":      "Nível máximo!",
        "time_label":  "Tempo de estudo",
        "time_h":      "h",
        "time_m":      "min",
        "time_zero":   "< 1 min",
    },
    "it": {
        ...
        "days":        "giorni",
        "no_streak":   "0 giorni",
        "xp_next":     "+{n} XP al prossimo livello",
        "xp_max":      "Livello massimo!",
        "time_label":  "Tempo di studio",
        "time_h":      "h",
        "time_m":      "min",
        "time_zero":   "< 1 min",
    },
    "pl": {
        ...
        "days":        "dni",
        "no_streak":   "0 dni",
        "xp_next":     "+{n} XP do następnego poziomu",
        "xp_max":      "Maksymalny poziom!",
        "time_label":  "Czas nauki",
        "time_h":      "godz",
        "time_m":      "min",
        "time_zero":   "< 1 min",
    },
    "ru": {
        ...
        "days":        "дн",
        "no_streak":   "0 дней",
        "xp_next":     "+{n} XP до след. уровня",
        "xp_max":      "Максимальный уровень!",
        "time_label":  "Время учёбы",
        "time_h":      "ч",
        "time_m":      "мин",
        "time_zero":   "< 1 мин",
    },
    "ca": {
        ...
        "days":        "dies",
        "no_streak":   "0 dies",
        "xp_next":     "+{n} XP per al següent nivell",
        "xp_max":      "Nivell màxim!",
        "time_label":  "Temps d'estudi",
        "time_h":      "h",
        "time_m":      "min",
        "time_zero":   "< 1 min",
    },
    "nl": {
        ...
        "days":        "dagen",
        "no_streak":   "0 dagen",
        "xp_next":     "+{n} XP tot volgend niveau",
        "xp_max":      "Maximaal niveau!",
        "time_label":  "Studietijd",
        "time_h":      "u",
        "time_m":      "min",
        "time_zero":   "< 1 min",
    },
...
_BADGE_STRINGS: dict[str, dict[str, tuple[str, str]]] = {
    ...
    "fr": {
        "first_lesson": ("Premier pas",      "Première leçon terminée"),
        "streak_3":     ("3 jours",          "Série de 3 jours"),
        "streak_7":     ("Une semaine",      "Série de 7 jours"),
        "streak_30":    ("Un mois",          "Série de 30 jours"),
        "level_2":      ("Niveau 2",         "Niveau Apprenant atteint"),
        "level_4":      ("Niveau 4",         "Niveau Praticien atteint"),
        "level_6":      ("Niveau 6",         "Niveau Maître atteint"),
        "lessons_5":    ("5 leçons",         "5 leçons terminées"),
        "lessons_10":   ("10 leçons",        "10 leçons terminées"),
        "lessons_25":   ("25 leçons",        "25 leçons terminées"),
        "daily_100":    ("Productif",        "100+ XP en une journée"),
    },
    "de": {
        "first_lesson": ("Erster Schritt",   "Erste Lektion abgeschlossen"),
        "streak_3":     ("3 Tage",           "3-Tage-Serie"),
        "streak_7":     ("Eine Woche",       "7-Tage-Serie"),
        "streak_30":    ("Ein Monat",        "30-Tage-Serie"),
        "level_2":      ("Level 2",          "Level „Lernender“ erreicht"),
        "level_4":      ("Level 4",          "Level „Übender“ erreicht"),
        "level_6":      ("Level 6",          "Level „Meister“ erreicht"),
        "lessons_5":    ("5 Lektionen",      "5 Lektionen abgeschlossen"),
        "lessons_10":   ("10 Lektionen",     "10 Lektionen abgeschlossen"),
        "lessons_25":   ("25 Lektionen",     "25 Lektionen abgeschlossen"),
        "daily_100":    ("Produktiv",        "100+ XP an einem Tag"),
    },
    "ja": {
        "first_lesson": ("最初の一歩",         "初めてのレッスンを完了"),
        "streak_3":     ("3日連続",           "3日連続学習"),
        "streak_7":     ("1週間",             "7日連続学習"),
        "streak_30":    ("1ヶ月",             "30日連続学習"),
        "level_2":      ("レベル2",           "「学習者」レベルに到達"),
        "level_4":      ("レベル4",           "「実践者」レベルに到達"),
        "level_6":      ("レベル6",           "「達人」レベルに到達"),
        "lessons_5":    ("レッスン5回",        "5レッスン完了"),
        "lessons_10":   ("レッスン10回",       "10レッスン完了"),
        "lessons_25":   ("レッスン25回",       "25レッスン完了"),
        "daily_100":    ("生産的な日",         "1日で100+ XP"),
    },
    "zh": {
        "first_lesson": ("第一步",            "完成第一课"),
        "streak_3":     ("连续3天",           "连续学习3天"),
        "streak_7":     ("一周",              "连续学习7天"),
        "streak_30":    ("一个月",            "连续学习30天"),
        "level_2":      ("等级2",             "达到“学习者”等级"),
        "level_4":      ("等级4",             "达到“练习者”等级"),
        "level_6":      ("等级6",             "达到“大师”等级"),
        "lessons_5":    ("5节课",             "完成5节课"),
        "lessons_10":   ("10节课",            "完成10节课"),
        "lessons_25":   ("25节课",            "完成25节课"),
        "daily_100":    ("高效的一天",         "单日100+ XP"),
    },
    "pt": {
        "first_lesson": ("Primeiro passo",   "Concluiu a primeira lição"),
        "streak_3":     ("3 dias",           "Sequência de 3 dias"),
        "streak_7":     ("Uma semana",       "Sequência de 7 dias"),
        "streak_30":    ("Um mês",           "Sequência de 30 dias"),
        "level_2":      ("Nível 2",          "Alcançou o nível Aprendiz"),
        "level_4":      ("Nível 4",          "Alcançou o nível Praticante"),
        "level_6":      ("Nível 6",          "Alcançou o nível Mestre"),
        "lessons_5":    ("5 lições",         "Concluiu 5 lições"),
        "lessons_10":   ("10 lições",        "Concluiu 10 lições"),
        "lessons_25":   ("25 lições",        "Concluiu 25 lições"),
        "daily_100":    ("Produtivo",        "100+ XP em um dia"),
    },
    "it": {
        "first_lesson": ("Primo passo",      "Prima lezione completata"),
        "streak_3":     ("3 giorni",         "Serie di 3 giorni"),
        "streak_7":     ("Una settimana",    "Serie di 7 giorni"),
        "streak_30":    ("Un mese",          "Serie di 30 giorni"),
        "level_2":      ("Livello 2",        "Raggiunto il livello Apprendista"),
        "level_4":      ("Livello 4",        "Raggiunto il livello Praticante"),
        "level_6":      ("Livello 6",        "Raggiunto il livello Maestro"),
        "lessons_5":    ("5 lezioni",        "Completate 5 lezioni"),
        "lessons_10":   ("10 lezioni",       "Completate 10 lezioni"),
        "lessons_25":   ("25 lezioni",       "Completate 25 lezioni"),
        "daily_100":    ("Produttivo",       "100+ XP in un giorno"),
    },
    "pl": {
        "first_lesson": ("Pierwszy krok",    "Ukończono pierwszą lekcję"),
        "streak_3":     ("3 dni",            "Seria 3 dni"),
        "streak_7":     ("Tydzień",          "Seria 7 dni"),
        "streak_30":    ("Miesiąc",          "Seria 30 dni"),
        "level_2":      ("Poziom 2",         "Osiągnięto poziom Uczeń"),
        "level_4":      ("Poziom 4",         "Osiągnięto poziom Praktyk"),
        "level_6":      ("Poziom 6",         "Osiągnięto poziom Mistrz"),
        "lessons_5":    ("5 lekcji",         "Ukończono 5 lekcji"),
        "lessons_10":   ("10 lekcji",        "Ukończono 10 lekcji"),
        "lessons_25":   ("25 lekcji",        "Ukończono 25 lekcji"),
        "daily_100":    ("Produktywny",      "100+ XP w jeden dzień"),
    },
    "ru": {
        "first_lesson": ("Первый шаг",       "Завершён первый урок"),
        "streak_3":     ("3 дня подряд",     "Серия 3 дня подряд"),
        "streak_7":     ("Неделя",           "Серия 7 дней подряд"),
        "streak_30":    ("Месяц",            "Серия 30 дней подряд"),
        "level_2":      ("Уровень 2",        "Достигнут уровень «Ученик»"),
        "level_4":      ("Уровень 4",        "Достигнут уровень «Практик»"),
        "level_6":      ("Уровень 6",        "Достигнут уровень «Мастер»"),
        "lessons_5":    ("5 уроков",         "Завершено 5 уроков"),
        "lessons_10":   ("10 уроков",        "Завершено 10 уроков"),
        "lessons_25":   ("25 уроков",        "Завершено 25 уроков"),
        "daily_100":    ("Продуктивный день", "100+ XP за один день"),
    },
    "ca": {
        "first_lesson": ("Primer pas",       "Has completat la primera lliçó"),
        "streak_3":     ("3 dies",           "Ratxa de 3 dies"),
        "streak_7":     ("Una setmana",      "Ratxa de 7 dies"),
        "streak_30":    ("Un mes",           "Ratxa de 30 dies"),
        "level_2":      ("Nivell 2",         "Has arribat al nivell Aprenent"),
        "level_4":      ("Nivell 4",         "Has arribat al nivell Practicant"),
        "level_6":      ("Nivell 6",         "Has arribat al nivell Mestre"),
        "lessons_5":    ("5 lliçons",        "Has completat 5 lliçons"),
        "lessons_10":   ("10 lliçons",       "Has completat 10 lliçons"),
        "lessons_25":   ("25 lliçons",       "Has completat 25 lliçons"),
        "daily_100":    ("Productiu",        "100+ XP en un dia"),
    },
    "nl": {
        "first_lesson": ("Eerste stap",      "Eerste les voltooid"),
        "streak_3":     ("3 dagen",          "Reeks van 3 dagen"),
        "streak_7":     ("Een week",         "Reeks van 7 dagen"),
        "streak_30":    ("Een maand",        "Reeks van 30 dagen"),
        "level_2":      ("Niveau 2",         "Niveau Leerling bereikt"),
        "level_4":      ("Niveau 4",         "Niveau Beoefenaar bereikt"),
        "level_6":      ("Niveau 6",         "Niveau Meester bereikt"),
        "lessons_5":    ("5 lessen",         "5 lessen voltooid"),
        "lessons_10":   ("10 lessen",        "10 lessen voltooid"),
        "lessons_25":   ("25 lessen",        "25 lessen voltooid"),
        "daily_100":    ("Productief",       "100+ XP op één dag"),
    },
}
