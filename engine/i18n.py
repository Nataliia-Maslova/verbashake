...
STRINGS = {
    "en": {
        ...
        "custom_pairs_hint": "One phrase per line in the format **{native} = {target}**. Example:\n\n`I want coffee = Я хочу каву`\n`How much is it? = Скільки коштує?`",
        "custom_pairs_label": "Phrase pairs ({native} = {target})",
        "custom_pairs_ph": "{native} = {target}\n...\n...",
        "custom_recognized": "Recognized {n} pair(s):",
        "custom_more_pairs": "... and {n} more",
        "custom_no_pairs": "No valid pairs found. Make sure you use `=` between phrases.",
        ...
        "custom_generate_expander": "✨ Or generate from a word list",
        "custom_generate_words_label": "Words (up to 20, comma-separated)",
        "custom_generate_words_ph": "nose, eye, lips, leg",
        "custom_generate_topic_label": "Grammar topic",
        "custom_generate_topic_ph": "e.g. I have got / we have / they have",
        "custom_generate_btn": "✨ Generate sentences",
        "custom_generate_too_many": "Too many words — use 20 at most.",
        "custom_generate_need_both": "Enter both a word list and a grammar topic.",
    ...
    "uk": {
        ...
        "custom_pairs_hint": "Список фраз — по одній на рядок у форматі **{native} = {target}**. Приклад:\n\n`Я хочу каву = I want a coffee`\n`Скільки коштує? = How much is it?`",
        "custom_pairs_label": "Пари фраз ({native} = {target})",
        "custom_pairs_ph": "{native} = {target}\n...\n...",
        "custom_recognized": "Розпізнано {n} пар(и):",
        "custom_more_pairs": "... та ще {n} пар",
        "custom_no_pairs": "Жодної валідної пари не знайдено. Перевірте, що використовуєте `=` між фразами.",
        ...
        "custom_generate_expander": "✨ Або згенеруй зі списку слів",
        "custom_generate_words_label": "Слова (до 20, через кому)",
        "custom_generate_words_ph": "ніс, око, губи, нога",
        "custom_generate_topic_label": "Граматична тема",
        "custom_generate_topic_ph": "наприклад: I have got / we have / they have",
        "custom_generate_btn": "✨ Згенерувати речення",
        "custom_generate_too_many": "Забагато слів — введи щонайбільше 20.",
        "custom_generate_need_both": "Введи і слова, і граматичну тему.",
    ...
    "es": {
        ...
        "custom_pairs_hint": "Una frase por línea en el formato **{native} = {target}**. Ejemplo:\n\n`Quiero un café = I want a coffee`\n`¿Cuánto cuesta? = How much is it?`",
        "custom_pairs_label": "Pares de frases ({native} = {target})",
        "custom_pairs_ph": "{native} = {target}\n...\n...",
        "custom_recognized": "Se reconocieron {n} par(es):",
        "custom_more_pairs": "... y {n} más",
        "custom_no_pairs": "No se encontraron pares válidos. Asegúrate de usar `=` entre las frases.",
        ...
        "custom_generate_expander": "✨ O genera desde una lista de palabras",
        "custom_generate_words_label": "Palabras (hasta 20, separadas por comas)",
        "custom_generate_words_ph": "nariz, ojo, labios, pierna",
        "custom_generate_topic_label": "Tema gramatical",
        "custom_generate_topic_ph": "p. ej.: I have got / we have / they have",
        "custom_generate_btn": "✨ Generar frases",
        "custom_generate_too_many": "Demasiadas palabras — usa 20 como máximo.",
        "custom_generate_need_both": "Introduce tanto la lista de palabras como el tema gramatical.",
