...
STRINGS = {
    "en": {
        ...
        "text_ai_search_subtitle": "📄 Find articles & Instagram accounts, on your topic",
        "text_ai_search_intro": "Same idea, but for reading: copy this prompt to get articles, texts, and Instagram accounts in your target language, matched to your level and interests:",
        "discuss_title":            "💬 Discuss it with AI",
        "discuss_intro":            "Found a video or article you like? Paste an excerpt or a short description below and discuss it with an AI tutor in your target language.",
        "discuss_context_label":    "What are we discussing?",
        "discuss_context_placeholder": "Paste a paragraph from the article, or describe the video you watched…",
        "discuss_start_btn":        "▶ Start discussion",
        "discuss_change_btn":       "🔄 Discuss something else",
        "discuss_end_btn":          "🏁 End discussion",
        "discuss_send_btn":         "➤ Send",
        "discuss_ai_label":         "AI",
        "discuss_message_placeholder": "Your message...",
        "feedback_title":       "🐛 Report a problem",
        "feedback_placeholder": "What went wrong? The more detail, the easier it is to fix...",
        "feedback_send_btn":    "Send",
        "feedback_sent_msg":    "Thanks — got it.",
        "unexpected_error_msg": "Something went wrong on our end. It's been logged — try again, or go back to the main menu.",
        "account_delete_title":            "⚠️ Delete my account",
        "account_delete_warning":          "This permanently deletes your progress, mastery, streak, XP, saved phrases, and any active subscription (cancelled immediately). This can't be undone.",
        "account_delete_type_label":       "Type DELETE to confirm",
        "account_delete_type_placeholder": "DELETE",
    ...
    "uk": {
        ...
        "text_ai_search_subtitle": "📄 Знайди статті та Instagram-акаунти на свою тему",
        "text_ai_search_intro": "Та сама ідея, тільки для читання: скопіюй цей запит і отримаєш статті, тексти та Instagram-акаунти цільовою мовою під твій рівень і інтереси:",
        "discuss_title":            "💬 Обговори з AI",
        "discuss_intro":            "Знайшов відео чи статтю, яка сподобалась? Встав уривок або короткий опис нижче — й обговори це з AI-тьютором цільовою мовою.",
        "discuss_context_label":    "Що обговорюємо?",
        "discuss_context_placeholder": "Встав абзац зі статті або опиши відео, яке подивився…",
        "discuss_start_btn":        "▶ Почати обговорення",
        "discuss_change_btn":       "🔄 Обговорити щось інше",
        "discuss_end_btn":          "🏁 Завершити обговорення",
        "discuss_send_btn":         "➤ Надіслати",
        "discuss_ai_label":         "AI",
        "discuss_message_placeholder": "Твоє повідомлення...",
        "feedback_title":       "🐛 Повідомити про проблему",
        "feedback_placeholder": "Що пішло не так? Чим детальніше, тим легше це виправити...",
        "feedback_send_btn":    "Надіслати",
        "feedback_sent_msg":    "Дякуємо — отримали.",
        "unexpected_error_msg": "Щось пішло не так з нашого боку. Це вже залоговано — спробуй ще раз або повернись у головне меню.",
        "account_delete_title":            "⚠️ Видалити мій акаунт",
        "account_delete_warning":          "Це назавжди видалить твій прогрес, mastery, серію, XP, збережені фрази й активну підписку (скасується одразу). Це неможливо скасувати.",
        "account_delete_type_label":       "Введи DELETE, щоб підтвердити",
        "account_delete_type_placeholder": "DELETE",
        "account_delete_confirm_btn":      "Видалити акаунт назавжди",
